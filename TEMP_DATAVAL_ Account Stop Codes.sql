...
set @dl_date = 
	(
		...
		SELECT top 1000  MEMBER_NBR = s.MEMBER_NBR
		...
		LEFT JOIN ACCOUNTWARNING al on s.dl_load_date = al.dl_load_date and s.MEMBER_NBR = al.MEMBER_NBR and s.SHARE_NBR = al.ACCOUNT_NBR
